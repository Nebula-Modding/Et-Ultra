package io.github.nebulamodding.registry.blocktypes;
...
public class FrigusFarmlandBlock extends FarmBlock {
    ...
    public static void turnToFrigusDirt(@Nullable Entity entity, BlockState state, Level level, BlockPos pos) {
        level.setBlockAndUpdate(pos, pushEntitiesUp(state, EUBlocks.FRIGUS_DIRT.get().defaultBlockState(), level, pos));
