...
public class EUBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(EUBlocks.SALT_COMPRESSED_BLOCKS.get("salt_block").get())
                .add(EUBlocks.SALT_COMPRESSED_BLOCKS.get("chiseled_salt").get())
                .add(EUBlocks.SALT_COMPRESSED_BLOCKS.get("polished_salt").get())
                .add(EUBlocks.SALT_COMPRESSED_BLOCKS.get("salt_bricks").get())
                .add(EUBlocks.SALT_COMPRESSED_BLOCKS.get("cracked_salt_bricks").get())
                .add(EUBlocks.SALT_COMPRESSED_BLOCKS.get("salt_tiles").get())
                .add(EUBlocks.SALT_COMPRESSED_BLOCKS.get("salt_pillar").get())

                // Graphite
                .add(EUBlocks.GRAPHITE_BLOCKS.get("graphite_block").get())
                .add(EUBlocks.GRAPHITE_BLOCKS.get("chiseled_graphite").get())
                .add(EUBlocks.GRAPHITE_BLOCKS.get("polished_graphite").get())
                .add(EUBlocks.GRAPHITE_BLOCKS.get("graphite_bricks").get())
                .add(EUBlocks.GRAPHITE_BLOCKS.get("cracked_graphite_bricks").get())
                .add(EUBlocks.GRAPHITE_BLOCKS.get("graphite_tiles").get())
                .add(EUBlocks.GRAPHITE_BLOCKS.get("graphite_pillar").get())
        ;
